 ...
 *
 * Public surface is factory-style: Diagram('#canvas') returns `g`, and
...
(function (global) {
  ...
  // assigns cls itself (see spec.md "Restraint").
  const NODE_PALETTE = {
    neutral: '#9aa1ab',
    go: '#2f9e5b',
    nogo: '#d1473f',
  ...
  class DiagramCore {
    ...
    // ---- edit mode (deferred in spec.md, pulled forward on request) ----
    ...
    _exportCode() {
      ...
      const lines = ["const g = Diagram('#canvas');", ''];
